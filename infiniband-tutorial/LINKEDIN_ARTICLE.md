...
For hands-on benchmarking, see the accompanying [tutorial notebook](https://github.com/elizabetht/spark/blob/main/infiniband-tutorial/01_InfiniBand_Tutorial.ipynb).
...
Next up: MicroK8s cluster with a CPU controller node, and prefill/decode disaggregated serving where 1-2μs RDMA latency becomes critical for KV-cache transfers between nodes.

*Can disaggregated serving actually improve throughput?* Stay tuned.
